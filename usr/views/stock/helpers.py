...
def get_color_mapping(page):
    ...
    }.get(None, colors['text_primary']) # This was a bug in original _c, fixing it to be a proper mapping
...
def get_color_mapping(page):
    # This is a duplicate of the logic above but separated for clarity
    colors = get_safe_colors(page)
    return {
        'GREY_300': colors['text_hint'],
        'GREY_400': colors['text_secondary'],
