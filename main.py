...
try:
    ...
    # Si falla la configuración, creamos un objeto dummy para que no rompa el inicio
    class DummySettings:
...
class ControlEntradasSalidasApp:
    ...
    def main(self, page: ft.Page):
        ...
        # 1. SPLASH SCREEN (Elegante y funcional)
...
# --- PUNTO DE ENTRADA ---
# Nota: La indentación debe estar en la raíz (sin espacios antes), 
# fuera de la clase ControlEntradasSalidasApp

def start_app(page: ft.Page):
    app_instance = ControlEntradasSalidasApp()
    app_instance.main(page)

# Ejecución directa para asegurar compatibilidad en Android
