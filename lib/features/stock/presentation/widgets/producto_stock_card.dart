...
/// destacado con color según el nivel. Recibe las existencias ya cargadas
/// de una sola query (evita el N+1).
class ProductoStockCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final exis = almacen != null
        ? existencias.where((e) => e.almacen == almacen).toList()
        : existencias;
